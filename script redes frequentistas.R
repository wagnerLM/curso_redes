...
# representaçao grafica e correlaçoes bivariadas
...
# medidas de centralidade (força, proximidade e conectividade; considerando o valor absoluto dos vertices)
