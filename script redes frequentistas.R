...
# representação gráfica e correlações bivariadas
...
# flow chart: quais os preditores de "não ter iniciativa"
flow(dass_d_g,"DASS5")

# pathways: qual a influência da "falta de sentido" em "não ter iniciativa"
...
# medidas de centralidade (força, proximidade e conectividade; considerando o valor absoluto dos vértices)
centralityPlot(dass_g,labels = dass21_names)
# influência esperada (soma dos vértices, considerando o sinal)
centralityPlot(dass_g,include = "ExpectedInfluence",orderBy = "ExpectedInfluence",labels = dass21_names)

# análise de comunidades (agrupamentos dentro de uma rede)
# pacote igraph
library(igraph)
